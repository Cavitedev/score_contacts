...
import '../../domain/mention/i_mentionable.dart' as _i12;
import '../../domain/user/contacts_data/contact.dart' as _i11;
import '../../domain/user/diary/diary_entry.dart' as _i13;
    ...
    AddDiaryPageRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i9.AddDiaryPage(
              key: args.key,
              mentionableList: args.mentionableList,
...
class AddDiaryPageRoute extends _i1.PageRouteInfo<AddDiaryPageRouteArgs> {
  AddDiaryPageRoute(
      {_i2.Key? key,
      required List<_i12.IMentionable> mentionableList,
      _i13.DiaryEntry? diaryEntry})
      : super(name,
            path: '/add-diary-page',
...
class AddDiaryPageRouteArgs {
  const AddDiaryPageRouteArgs(
      {this.key, required this.mentionableList, this.diaryEntry});

  final _i2.Key? key;

  final List<_i12.IMentionable> mentionableList;

  final _i13.DiaryEntry? diaryEntry;
}

class ListDiaryEntryPageRoute
    extends _i1.PageRouteInfo<ListDiaryEntryPageRouteArgs> {
  ListDiaryEntryPageRoute({_i12.IMentionable? mentionable})
      : super(name,
            path: '/list-diary-entry-page',
...
class ListDiaryEntryPageRouteArgs {
  ...
  final _i12.IMentionable? mentionable;
}
