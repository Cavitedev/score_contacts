...
class _$AddDiaryEntryEventTearOff {
  ...
  _Initialize initialize({required List<IMentionable> mentionableList}) {
    return _Initialize(
...
mixin _$AddDiaryEntryEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<IMentionable> mentionableList) initialize,
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(List<IMentionable> mentionableList)? initialize,
    TResult Function(
            String text, int baseOffset, int extentOffset, String trigger)?
        onEntryTextChanged,
...
abstract class _$InitializeCopyWith<$Res> {
  ...
  $Res call({List<IMentionable> mentionableList});
}
...
class _$_Initialize implements _Initialize {
  const _$_Initialize({required this.mentionableList});
  ...
  @override
  String toString() {
    return 'AddDiaryEntryEvent.initialize(mentionableList: $mentionableList)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return initialize(mentionableList);
  }
...
abstract class _Initialize implements AddDiaryEntryEvent {
  const factory _Initialize({required List<IMentionable> mentionableList}) =
      _$_Initialize;
...
class _$_AddDiaryEntryState extends _AddDiaryEntryState {
  const _$_AddDiaryEntryState(
      {required this.entryField, required this.mentionListManager})
      : super._();
  ...
  @override
  String toString() {
    return 'AddDiaryEntryState(entryField: $entryField, mentionListManager: $mentionListManager)';
  }
...
abstract class _AddDiaryEntryState extends AddDiaryEntryState {
  const factory _AddDiaryEntryState(
      {required DiaryEntryApplication entryField,
      required MentionListManager mentionListManager}) = _$_AddDiaryEntryState;
