...
import '../../application/contacts/add_contact/add_contact_bloc.dart' as _i15;
...
import '../../domain/user/contacts_data/i_contact_repository.dart' as _i13;
import '../../infrastructure/auth/firebase_auth_facade.dart' as _i9;
import '../../infrastructure/contacts/contacts_image_storage.dart' as _i12;
import '../../infrastructure/contacts/contacts_repository.dart' as _i14;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i12.ContactsImageStorage>(() => _i12.ContactsImageStorage(
      get<_i6.FirebaseStorage>(), get<_i8.IAuthFacade>()));
  gh.lazySingleton<_i13.IContactsRepository>(() => _i14.ContactsRepository(
      get<_i5.FirebaseFirestore>(), get<_i12.ContactsImageStorage>()));
  gh.factory<_i15.AddContactBloc>(
      () => _i15.AddContactBloc(get<_i13.IContactsRepository>()));
  gh.factory<_i16.ContactActorBloc>(
      () => _i16.ContactActorBloc(get<_i13.IContactsRepository>()));
  gh.factory<_i17.ContactWatcherBloc>(
      () => _i17.ContactWatcherBloc(get<_i13.IContactsRepository>()));
  return get;
}
