...
void main() {
  ...
  test(
      "Convert json String of device to Contact class should work with single company", () {
    final Contact contact = Contact(
        id: UniqueID.fromUniqueString("1"),
        nameData: const NameData(firstName: "hola"),
      companies: [const Company(name: "comp", title: "title")]
        );

    const String json =
        '{"id":"1","name":"hola","companies":{"name":"comp","title":"title"}}';

    expect(Contact.fromStringJson(json), contact);
  });

  test(
      "Convert json String of device to Contact class should work with several companies", () {
    final Contact contact = Contact(
        id: UniqueID.fromUniqueString("1"),
        nameData: const NameData(firstName: "hola"),
        companies: [const Company(name: "comp", title: "title"), const Company(name: "comp2", title: "title2")]
    );

    const String json =
        '{"id":"1","name":"hola","companies":[{"name":"comp","title":"title"},{"name":"comp2","title":"title2"}]}';
